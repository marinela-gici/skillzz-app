        ...
        <>
            {job._id &&
                <div>
                    {/*job details*/}
                    <div className="p-8">
                        <div className="w-full mx-auto p-12 shadow-box rounded-md dark:dark:bg-gray-800 dark:text-white">
                    ...
                    <div className="p-8 relative overflow-x-auto shadow-md sm:rounded-lg">
                        <p className="dark:text-white pb-4">Applicants
                            for <span className="text-emerald-400 dark:text-rose-500">{job.title}</span> position</p>
